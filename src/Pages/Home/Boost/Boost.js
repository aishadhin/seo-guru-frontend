...
const Boost = () => {
    ...
    return (
        <div className='py-16 container mx-auto'>
            <h2 className='lg:text-4xl text-2xl px-6 lg:w-[38rem] mx-auto font-bold text-center text-primary leading-relaxed'>Boost Your Organic Traffic By Our White Label Strategy</h2>
            <div className='h-[2px] w-60 mx-auto bg-primary'></div>
            <div className='mt-6 grid p-6 lg:grid-cols-3 grid-rows-1 gap-6'>
